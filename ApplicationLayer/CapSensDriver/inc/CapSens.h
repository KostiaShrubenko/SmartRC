...
#define TOP_HIGH_LEVEL 		((1 << PIN1) | (1 << PIN2) | (1 << PIN3) | (1 << PIN4) |\
...
#define BOTTOM_PINS (LL_GPIO_PIN_0  | LL_GPIO_PIN_1  | LL_GPIO_PIN_2  | LL_GPIO_PIN_10 |\
					 LL_GPIO_PIN_13 | LL_GPIO_PIN_12 | LL_GPIO_PIN_13 | LL_GPIO_PIN_14)
...
#define TOP_CRL_MASK 	(PIN1_CRL_MASK    |  PIN2_CRL_MASK   | PIN3_CRL_MASK | PIN4_CRL_MASK |\
						 PIN5_CRL_MASK    | PIN6_CRL_MASK    | PIN7_CRL_MASK)
#define TOP_MODE_FLOAT 	(GPIO_CRL_CNF1_0  | GPIO_CRL_CNF2_0  | GPIO_CRL_CNF3_0 | GPIO_CRL_CNF4_0 |\
						 GPIO_CRL_CNF5_0  | GPIO_CRL_CNF6_0  | GPIO_CRL_CNF7_0)
#define TOP_MODE_OUTPUT (GPIO_CRL_MODE1_0 | GPIO_CRL_MODE2_0 | GPIO_CRL_MODE3_0 | GPIO_CRL_MODE4_0 |\
